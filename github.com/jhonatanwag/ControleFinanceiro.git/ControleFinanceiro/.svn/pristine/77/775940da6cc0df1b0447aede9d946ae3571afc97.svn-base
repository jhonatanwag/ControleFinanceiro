...
var descontoProduto = function() {	
	PF('DlgRenomear').show();
}

var hide = function() {
	PF('DlgDescontoVenda').hide();
}


var abrirPesquisaProduto = function() {
	jQuery("#botao2").click();
}

var renomearProduto = function() {	
	renomearProduto();
}



$("#layout-portlets-cover").keydown(function(event) {
