package br.com.controlefinanceiro.util.report;
...
public class ExecutorRelatorio implements Work {
	...
	public ExecutorRelatorio(String caminhoRelatorio, HttpServletResponse response, Map<String, Object> parametros,
			List<? extends Object> objetos, String nomeArquivoSaida) {
		this.caminhoRelatorio = caminhoRelatorio;
		this.response = response;
		this.parametros = parametros;
		this.dataSource = new JRBeanCollectionDataSource(objetos);
		this.nomeArquivoSaida = nomeArquivoSaida;
	...
	public void execute(Connection connection) throws SQLException {
		try {
			...
			if (this.dataSource != null) {
				print = JasperFillManager.fillReport(relatorioStream, this.parametros, this.dataSource);
			} else {
